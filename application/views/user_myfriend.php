...
<html>
  ...
  <!--==============================header=================================-->
	...
	<div class="user_main">
		<div class="lastlook">
			<div class="user_friends">
				...
				<div class="user_friends_talk"><img src="<?=base_url();?>images/comment.png"/><span>发信息</span></div>
			
				
				
				<div class="user_friends_delete"><span>删除好友</span></div>
			</div>
			<div class="user_friends">
				<div class="user_art_Headimg"><img src="<?=base_url();?>images/1.jpg" style="border-radius:30px;"></div>
				<div class="user_art_authorid"><span>好友2昵称</span></div>
	...
	<script>
		...
		//板块层是隐藏和显示
			 $(".dh").click(function(){
			 var plateview=$(".user_friends_delete").is(":hidden"); //该层是否隐藏
			 if(plateview){    //如果层是隐藏的
			 $(".user_friends_delete").fadeIn();
			 $("#dh_text").text("完成");
			// $(".dh").css("right","230px");
		...
		var user_main_height=$(".user_main").height();
		if(user_main_height<495){
			$(".user_main").css("height","495px");
		}
		...
		history.back();});
		//点击好友，跳转到用户展示页面
		$(".user_art_Headimg").click(function(){
		location.href = "show_user_info.html";})
		$(".user_friends_talk").click(function(){
