    ...
    <div class="lastlook">
        <?php for($i=0;$i<10;$i++){?>
            <div class="user_article">
                ...
                <div class="user_art_brief"><span>用户<?=$i+1?>昵称：</span></div>
                <div class="user_art_brief"><span>用户<?=$i+1?>注册时间：15/06/22</span></div>
                <div class="user_art_brief">   <span>    ...</span></div>
                <div class="user_art_delete"><span>删除该文章</span></div>
            </div>
        <?php }?>
    </div><br>
    <div class="report_newarticle"><a>添加新用户</a></div>
